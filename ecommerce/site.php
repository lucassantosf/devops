...
$app->get("/order/:idorder/pagseguro", function($idorder){
	...
	$page->setTpl("payment-pagseguro",[
		...
		'phone'=>[
			...
			'number'=>substr($order->getnrphone(), strlen($order->getnrphone()))
		]
	]);
});
...
$app->post("/register", function(){
	...
	if(User::checkLoginExist($_POST['email']) === true){
		...
		User::setErrorRegister("Este endereço de email está em uso");
		header("Location: /login");
		exit();
	}
	$user = new User();
...
$app->get("/boleto/:idorder", function($idorder){
	...
	// SEUS DADOS
	$dadosboleto["identificacao"] = "L Store";
	$dadosboleto["cpf_cnpj"] = "24.700.731/0001-08";
	$dadosboleto["endereco"] = "Rua A SILVA, 99999 - Alvarenga, 99999-999";
