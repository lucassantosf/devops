  	...
  	<div class="col-md-12">
  		<div class="box box-primary">
            ...
            <div class="box-header">
              <a href="/php/ecommerce/admin/products/create" class="btn btn-success">Cadastrar Produto</a>
            </div>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/php/ecommerce/admin/products/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a>
                      <a href="/php/ecommerce/admin/products/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Excluir</a>
                    </td>
                  </tr>
                  <?php } ?>
