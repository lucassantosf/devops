...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/php/ecommerce/admin/categories">Categorias</a></li>
    <li class="active"><a href="/php/ecommerce/admin/categories/create">Cadastrar</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/php/ecommerce/admin/products/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="url" name="desurl">
            </div>
          </div>
          <!-- /.box-body -->
