            ...
            <div class="col-md-12">
                <div class="product-content-right">
                    <div class="woocommerce">
                        ...
                        <form action="/php/ecommerce/checkout">
                            <?php if( $error !=''  ){ ?>
                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="/php/ecommerce/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></a>
                                        </td>
                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cross-sells">
                                    ...
                                    <div class="coupon">
                                        ...
                                        <input type="submit" formmethod="post" formaction="/php/ecommerce/cart/freight" value="CÁLCULAR" class="button">
                                    </div>
