...
def read_data_from_s3(event):
    ...
    # Define data type from excel file - force it to be read like string 
    data = pd.read_excel(read_excel_data, dtype={'e-mail': str, 'datcntrt': str, 'data_aprovacao_cartao': str, 'data_desbloqueio_cartao': str})  
    return data
